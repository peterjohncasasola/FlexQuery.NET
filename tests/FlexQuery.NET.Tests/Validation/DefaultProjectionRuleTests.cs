...
public class DefaultProjectionRuleTests
{
    ...
    public void InjectsFromSelectableFields()
    {
        ...
        options.Select.Should().BeEquivalentTo(["Id", "Name"]);
    }
    ...
    public void InjectsFromRoleAllowedFields()
    {
        ...
        options.Select.Should().BeEquivalentTo(["Id", "Name", "Age"]);
    }
    ...
    public void ExcludesBlockedFields()
    {
        ...
        options.Select.Should().NotContain("Description");
    }
    ...
    public void WildcardExpansion_StarOnly()
    {
        ...
        options.Select.Should().Contain("Name");
        options.Select.Should().Contain("Age");
        options.Select.Should().Contain("Description");
    }

...
- [Execution Benchmarks](../execution-pipeline)
...
| EF Core + InMemory (tests) | [End-to-End Execution](../execution-pipeline) |
- ASP.NET Core REST API | [API Benchmarks](./api-benchmarks.md) |
- Microservices with large payloads | [Scalability](./scalability.md) |
- Need nested `Any` / `All` | [Execution: Nested](../execution-pipeline#scenario-3-nested-collection-queries-any) |

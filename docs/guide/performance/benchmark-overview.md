...
2. **[Expression Generation Benchmarks](./expression-generation.md)**
  ...
  3. **[End-to-End Execution Benchmarks](../execution-pipeline.md)**
...
If you are a library consumer deciding whether to adopt FlexQuery.NET, we recommend focusing entirely on the **[End-to-End Execution Benchmarks](../execution-pipeline.md)**. This reflects the actual latency added to your HTTP requests.

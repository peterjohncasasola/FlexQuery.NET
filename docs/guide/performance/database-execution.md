...
- [Execution Benchmarks](../execution-pipeline.md) (InMemory, includes Gridify, Sieve, Dynamic.Core)
...
For actual filtering overhead, see **[Execution Benchmarks](../execution-pipeline.md)** where all libraries execute entirely in-memory with comparable operations. There, FlexQuery.NET is 2.25× faster than handwritten (InMemory anomaly) or within margin of error on SQL.

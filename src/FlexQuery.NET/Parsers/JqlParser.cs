...
/// </summary>
public sealed class JqlParser : IQueryParser
{
    /// <inheritdoc />
    ...
    public QueryOptions Parse(FlexQueryParameters parameters)
    {
        ...
        {
            return QueryOptionsParser.InternalParseJql(parameters.RawParameters, parameters.Query!);
        }
        ...
        {
            var ast = Jql.JqlParser.Parse(parameters.Query);

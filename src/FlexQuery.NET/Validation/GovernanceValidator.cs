...
internal static class GovernanceValidator
{
    ...
    public static void ValidateConfiguration(QueryGovernanceOptions execOptions)
    {
        ...
        FieldAccessValidationRule.ValidateDefaultSortFieldConfiguration(execOptions);
    }
}

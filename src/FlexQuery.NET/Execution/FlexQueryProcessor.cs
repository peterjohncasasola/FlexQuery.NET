...
internal sealed class FlexQueryProcessor(FlexQueryOptions globalOptions) : IFlexQueryProcessor
{
        ...
        CancellationToken ct = default)
    {
        ...
        globalOptions.ApplyTo(execOptions);
        globalOptions.Freeze();
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var context = new QueryContext { TargetType = typeof(T), ExecutionOptions = options };
    ...
    private static int? TryGetTotalCount<T>(IQueryable<T> filteredQuery, QueryOptions options, BaseQueryOptions? execOptions = null)
    {

  ...
  return (
    <nav aria-label="Pagination" className="mt-14 grid grid-cols-1 gap-4 border-t border-zinc-200 pt-8 sm:grid-cols-2 dark:border-zinc-800">
      {prev ? (
        <Link
          href={`/docs/${prev.slug}`}
          className="group rounded-lg border border-zinc-200 p-4 transition-colors hover:border-brand-400 hover:bg-brand-50/40 dark:border-zinc-800 dark:hover:border-brand-700 dark:hover:bg-brand-950/20"
        >
      ...
      {next && (
        <Link
          href={`/docs/${next.slug}`}
          className="group rounded-lg border border-zinc-200 p-4 text-right transition-colors hover:border-brand-400 hover:bg-brand-50/40 sm:col-start-2 dark:border-zinc-800 dark:hover:border-brand-700 dark:hover:bg-brand-950/20"
        >

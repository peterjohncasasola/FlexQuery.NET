...
| :--- | :--- |
| Standard ASP.NET Core + EF Core API | `FlexQuery.NET.AspNetCore` |
| Swagger-documented API | `FlexQuery.NET.OpenApi` |
| Grid-driven dashboards | `FlexQuery.NET.Adapters.AgGrid` or `FlexQuery.NET.Adapters.Kendo` |
| OData/FQL clients | `FlexQuery.NET.Parsers.MiniOData` / `FlexQuery.NET.Parsers.Fql` |
| Debug/diagnostic tooling | `FlexQuery.NET.Diagnostics` |
